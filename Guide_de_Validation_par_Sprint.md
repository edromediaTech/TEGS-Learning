...
![Données analytiques issues du LRS xAPI](captures/10-analytics-dashboard.png)
...
![Interface War Room avec détection de perte de focus](captures/08-mobile-warroom.png)
...
![Synchronisation mobile et scanner superviseur](captures/15-supervisor-scanner.png)
