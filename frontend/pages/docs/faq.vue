...
const sections = [
  ...
  },
  {
    ...
    questions: [
      ...
      { id: 'ia-securite', question: 'L\'agent est-il securise contre les abus ?', answer: 'Oui, 9 couches de securite protegent le systeme : <strong>arret d\'urgence</strong> (Panic Mode), <strong>limitation de debit</strong> (messages/heure), <strong>controle des roles</strong>, <strong>confirmation humaine</strong> pour les actions sensibles, <strong>isolation par organisation</strong>, et <strong>journal d\'audit</strong> complet.' },
