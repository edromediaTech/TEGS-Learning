...
const articles = [
  ...
  { title: 'Modules & Studio — Creer et configurer', excerpt: 'Creez des modules dans le Studio : chapitres, ecrans, blocs de contenu, 8 types de questions, surveillance, proctoring, partage.', path: '/docs/admin/modules', role: 'admin', keywords: 'module studio creer chapitre ecran bloc question qcm surveillance proctoring partage theme' },
  { title: 'Calibrer la duree des quiz et questions', excerpt: 'Chronometre global, duree par question, mode concours, compensation de latence et bonnes pratiques de calibrage.', path: '/docs/admin/calibrage', role: 'admin', keywords: 'calibrage duree timer chronometre temps question global concours minute seconde' },
  { title: 'Generer des quiz par IA', excerpt: 'Utilisez l\'intelligence artificielle Gemini pour generer des questions en francais, creole, anglais ou espagnol.', path: '/docs/admin/ia-quiz', role: 'admin', keywords: 'ia intelligence artificielle generer quiz questions gemini creole francais anglais espagnol automatique' },
  { title: 'Piloter le live d\'un concours', excerpt: 'Demarrez les rounds, suivez le bracket en direct, diffusez sur TV/OBS, cloturez et generez les certificats.', path: '/docs/admin/live', role: 'admin', keywords: 'live demarrer round bracket cloturer qualifier certificat podium obs broadcast spectateur tv diffusion arena' },
